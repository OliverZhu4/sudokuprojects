...
* **Comments:** Again, since you are only going to write one long rule, provide a short descriptive comment before each unique group of sub-goals that that perform a collective task. The comments do not have to be in Java-doc style.
